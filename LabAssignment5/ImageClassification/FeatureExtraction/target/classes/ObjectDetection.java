...
//    private RenderMode renderMode = RenderMode.SQUARE;
    ...
    public ObjectMainDetection() throws IOException {
        ...
        this.matcher5 = new ConsistentLocalFeatureMatcher2d<Keypoint>(
                new FastBasicKeypointMatcher<Keypoint>(8));
        final RobustHomographyEstimator ransac = new RobustHomographyEstimator(0.1, 1000,
    ...
    public void StartVideo() throws IOException {
        ...
        Video<MBFImage> video = new XuggleVideo(new File("data2/Football_Iowa_20sec.mkv"));
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data2/white.jpg"));
            modelImage2 = ImageUtilities.readMBF(new File("data2/yellow.jpg"));
